...
public class Target implements IServer {
    ...
    public void setRegisteredUsers(ArrayList<User> newUsers) {registeredUsers = newUsers;}
    
    public ArrayList<Login> getLoggedinUsers() {return loggedinUsers;}
    public void setLoggedinUsers(ArrayList<Login> newUsers) {loggedinUsers = newUsers;}
    
    public ArrayList<Game> getAvailableGames() {return availableGames;}
    public void setAvailableGames(ArrayList<Game> newGames) {availableGames = newGames;}
    
    public ArrayList<Game> getActiveGames() {return activeGames;}
    public void setActiveGames(ArrayList<Game> newGames) {activeGames = newGames;}
