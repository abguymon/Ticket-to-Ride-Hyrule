...
public class TestLongestPath {
    public static void main(String[] args) {
        ...
        game.getPlayer("p1").addRoute(routes.get(38));
        game.getPlayer("p1").addRoute(routes.get(39));
        game.getPlayer("p1").addRoute(routes.get(41));
        //game.getPlayer("p1").addRoute(routes.get(32));
        game.getPlayer("p2").addRoute(routes.get(29));
        game.getPlayer("p2").addRoute(routes.get(28));
